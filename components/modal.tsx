...
export const EventSuccessModal: React.FC<{
  setModalVisible: any;
  modalVisible: boolean;
  name: string;
  message?: string;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {props.message ? props.message : " You successfully added the"}{" "}
            {props.name} {!props.message && " event"}
          </Text>
          ...
          <CenteredButton
            ...
            wRatio={2.4}
            radiusRatio={sizes.radius.sm}
            title={props.buttonTitle ? props.buttonTitle : "Add another event"}
            font={fonts.Regular}
            color={Colors.common.text.foreground}
            bgColor={Colors[colorScheme].tint}
            style={{
